 ...
 */
public class RadicalChangeAuto1 extends OpMode{

    DcMotor treadRight;
    DcMotor treadLeft;

    static double TrackWidth = 13.75; //in inches
    static double GearRatio = 32.0 / 24.0; //wheel to motor
    static int wheelDiameter = 3; //in inches
    static double wheelCircumference = wheelDiameter * Math.PI; //Calculating Circumference
    static int ClicksPerRotation = 1120; //declares encoder clicks per full rotation on andymark encoder
